...
if [ "$SEARCH_IN_FOLDER" ]; then
  ...
  FIND_DIR_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"kubernetes\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"kube-proxy\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \"pam.d\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"kubelet\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"system.d\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"system-connections\" -o -name \"concourse-auth\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CUSTOM=`eval_bckgrd "find $SEARCH_IN_FOLDER -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"sites.ini\" -o -name \"*.ovpn\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \".gitconfig\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"agent*\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"*.ftpconfig\" -o -name \"mongod*.conf\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"RDCMan.settings\" -o -name \"docker-compose.yml\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"iis6.log\" -o -name \"*knockd*\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"ssh*config\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name \"httpd.conf\" -o -name \"sess_*\" -o -name \"rsyncd.secrets\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \".bashrc\" -o -name \".msmtprc\" -o -name \"*.keystore\" -o -name \"rktlet.sock\" -o -name \"tomcat-users.xml\" -o -name \"https.conf\" -o -name \"sysprep.xml\" -o -name \"passwd.ibd\" -o -name \"SYSTEM\" -o -name \"exports\" -o -name \"log4j-core*.jar\" -o -name \"autologin.conf\" -o -name \"mosquitto.conf\" -o -name \"pagefile.sys\" -o -name \"*.gnupg\" -o -name \"autologin\" -o -name \"zabbix_server.conf\" -o -name \"mariadb.cnf\" -o -name \"psk.txt\" -o -name \"snmpd.conf\" -o -name \"ftp.ini\" -o -name \"appcmd.exe\" -o -name \"*.socket\" -o -name \"*.tfstate\" -o -name \"setupinfo\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  CONT_THREADS=0
  # FIND ALL KNOWN INTERESTING SOFTWARE FILES
  FIND_DIR_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"kubernetes\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"kube-proxy\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \"pam.d\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"kubelet\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"system.d\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"system-connections\" -o -name \"concourse-auth\" -o -name \"bind\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_HOMESEARCH=`eval_bckgrd "find $HOMESEARCH -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MEDIA=`eval_bckgrd "find ${ROOT_FOLDER}media -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_MNT=`eval_bckgrd "find ${ROOT_FOLDER}mnt -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_OPT=`eval_bckgrd "find ${ROOT_FOLDER}opt -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_PRIVATE=`eval_bckgrd "find ${ROOT_FOLDER}private -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SBIN=`eval_bckgrd "find ${ROOT_FOLDER}sbin -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SNAP=`eval_bckgrd "find ${ROOT_FOLDER}snap -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_SRV=`eval_bckgrd "find ${ROOT_FOLDER}srv -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_TMP=`eval_bckgrd "find ${ROOT_FOLDER}tmp -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_USR=`eval_bckgrd "find ${ROOT_FOLDER}usr -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"bind\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_DIR_VAR=`eval_bckgrd "find ${ROOT_FOLDER}var -type d -name \"zabbix\" -o -name \"couchdb\" -o -name \".svn\" -o -name \"mysql\" -o -name \"kubernetes\" -o -name \"sentry\" -o -name \".vnc\" -o -name \"*jenkins\" -o -name \"dirsrv\" -o -name \"kube-proxy\" -o -name \"nginx\" -o -name \"legacy_credentials\" -o -name \"environments\" -o -name \".password-store\" -o -name \"neo4j\" -o -name \"ErrorRecords\" -o -name \".docker\" -o -name \"postfix\" -o -name \"concourse-keys\" -o -name \"cacti\" -o -name \"filezilla\" -o -name \"keyrings\" -o -name \"varnish\" -o -name \"kubelet\" -o -name \"ipa\" -o -name \"gcloud\" -o -name \"ldap\" -o -name \".kube*\" -o -name \"roundcube\" -o -name \".irssi\" -o -name \"logstash\" -o -name \"sites-enabled\" -o -name \"doctl\" -o -name \"bind\" -o -name \"concourse-auth\" -o -name \".cloudflared\" -o -name \"seeddms*\" -o -name \".bluemix\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  ...
  FIND_APPLICATIONS=`eval_bckgrd "find ${ROOT_FOLDER}applications -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"sites.ini\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"*.ftpconfig\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"docker-compose.yml\" -o -name \"RDCMan.settings\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"setupinfo\" -o -name \"iis6.log\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name \"httpd.conf\" -o -name \"rsyncd.secrets\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \".bashrc\" -o -name \".msmtprc\" -o -name \"*.keystore\" -o -name \"rktlet.sock\" -o -name \"tomcat-users.xml\" -o -name \"https.conf\" -o -name \"sysprep.xml\" -o -name \"passwd.ibd\" -o -name \"SYSTEM\" -o -name \"log4j-core*.jar\" -o -name \"autologin.conf\" -o -name \"mosquitto.conf\" -o -name \"pagefile.sys\" -o -name \"*.gnupg\" -o -name \"autologin\" -o -name \"zabbix_server.conf\" -o -name \"mariadb.cnf\" -o -name \"psk.txt\" -o -name \"snmpd.conf\" -o -name \"ftp.ini\" -o -name \"appcmd.exe\" -o -name \"*.socket\" -o -name \"*.tfstate\" -o -name \".gitconfig\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_BIN=`eval_bckgrd "find ${ROOT_FOLDER}bin -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"sites.ini\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"*.ftpconfig\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"docker-compose.yml\" -o -name \"RDCMan.settings\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"setupinfo\" -o -name \"iis6.log\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name \"httpd.conf\" -o -name \"rsyncd.secrets\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \".bashrc\" -o -name \".msmtprc\" -o -name \"*.keystore\" -o -name \"rktlet.sock\" -o -name \"tomcat-users.xml\" -o -name \"https.conf\" -o -name \"sysprep.xml\" -o -name \"passwd.ibd\" -o -name \"SYSTEM\" -o -name \"log4j-core*.jar\" -o -name \"autologin.conf\" -o -name \"mosquitto.conf\" -o -name \"pagefile.sys\" -o -name \"*.gnupg\" -o -name \"autologin\" -o -name \"zabbix_server.conf\" -o -name \"mariadb.cnf\" -o -name \"psk.txt\" -o -name \"snmpd.conf\" -o -name \"ftp.ini\" -o -name \"appcmd.exe\" -o -name \"*.socket\" -o -name \"*.tfstate\" -o -name \".gitconfig\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CACHE=`eval_bckgrd "find ${ROOT_FOLDER}.cache -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"sites.ini\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"*.ftpconfig\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"docker-compose.yml\" -o -name \"RDCMan.settings\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"setupinfo\" -o -name \"iis6.log\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name \"httpd.conf\" -o -name \"rsyncd.secrets\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \".bashrc\" -o -name \".msmtprc\" -o -name \"*.keystore\" -o -name \"rktlet.sock\" -o -name \"tomcat-users.xml\" -o -name \"https.conf\" -o -name \"sysprep.xml\" -o -name \"passwd.ibd\" -o -name \"SYSTEM\" -o -name \"log4j-core*.jar\" -o -name \"autologin.conf\" -o -name \"mosquitto.conf\" -o -name \"pagefile.sys\" -o -name \"*.gnupg\" -o -name \"autologin\" -o -name \"zabbix_server.conf\" -o -name \"mariadb.cnf\" -o -name \"psk.txt\" -o -name \"snmpd.conf\" -o -name \"ftp.ini\" -o -name \"appcmd.exe\" -o -name \"*.socket\" -o -name \"*.tfstate\" -o -name \".gitconfig\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_CDROM=`eval_bckgrd "find ${ROOT_FOLDER}cdrom -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"sites.ini\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"*.ftpconfig\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"docker-compose.yml\" -o -name \"RDCMan.settings\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"setupinfo\" -o -name \"iis6.log\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name \"httpd.conf\" -o -name \"rsyncd.secrets\" -o -name \"id_rsa*\" -o -name \".k5login\" -o -name \".bashrc\" -o -name \".msmtprc\" -o -name \"*.keystore\" -o -name \"rktlet.sock\" -o -name \"tomcat-users.xml\" -o -name \"https.conf\" -o -name \"sysprep.xml\" -o -name \"passwd.ibd\" -o -name \"SYSTEM\" -o -name \"log4j-core*.jar\" -o -name \"autologin.conf\" -o -name \"mosquitto.conf\" -o -name \"pagefile.sys\" -o -name \"*.gnupg\" -o -name \"autologin\" -o -name \"zabbix_server.conf\" -o -name \"mariadb.cnf\" -o -name \"psk.txt\" -o -name \"snmpd.conf\" -o -name \"ftp.ini\" -o -name \"appcmd.exe\" -o -name \"*.socket\" -o -name \"*.tfstate\" -o -name \".gitconfig\" -o -name \"software.sav\" 2>/dev/null | sort; printf \\\$YELLOW'. '\\\$NC 1>&2;"`
  FIND_ETC=`eval_bckgrd "find ${ROOT_FOLDER}etc -name \".roadtools_auth\" -o -name \"containerd.sock\" -o -name \"*.keytab\" -o -name \"my.cnf\" -o -name \"zabbix_agentd.conf\" -o -name \"master.key\" -o -name \"software\" -o -name \"*.viminfo\" -o -name \"ftp.config\" -o -name \"error.log\" -o -name \".htpasswd\" -o -name \"groups.xml\" -o -name \"*.timer\" -o -name \"*.ovpn\" -o -name \"sites.ini\" -o -name \"system.sav\" -o -name \"FreePBX.conf\" -o -name \"settings.php\" -o -name \"printers.xml\" -o -name \"password*.ibd\" -o -name \"fastcgi_params\" -o -name \"wcx_ftp.ini\" -o -name \"scclient.exe\" -o -name \"plum.sqlite\" -o -name \".Xauthority\" -o -name \"rsyncd.conf\" -o -name \".ldaprc\" -o -name \"*.p12\" -o -name \".lesshst\" -o -name \"firebase-tools.json\" -o -name \"*.rdg\" -o -name \"nginx.conf\" -o -name \"secrets.ldb\" -o -name \"php.ini\" -o -name \"SAM\" -o -name \"snyk.config.json\" -o -name \"azureProfile.json\" -o -name \"wsl.exe\" -o -name \"*.vmdk\" -o -name \"creds*\" -o -name \"*.tf\" -o -name \"scheduledtasks.xml\" -o -name \"access_tokens.db\" -o -name \"airflow.cfg\" -o -name \"*.swp\" -o -name \"ffftp.ini\" -o -name \"server.xml\" -o -name \"*.key\" -o -name \"AppEvent.Evt\" -o -name \"adc.json\" -o -name \"*.jks\" -o -name \"winscp.ini\" -o -name \"vault-ssh-helper.hcl\" -o -name \"sitemanager.xml\" -o -name \"ConsoleHost_history.txt\" -o -name \"KeePass.enforced*\" -o -name \"bash.exe\" -o -name \".google_authenticator\" -o -name \"mongod*.conf\" -o -name \"*.ftpconfig\" -o -name \"wp-config.php\" -o -name \"kadm5.acl\" -o -name \".git-credentials\" -o -name \"access.log\" -o -name \"sssd.conf\" -o -name \"redis.conf\" -o -name \"pgsql.conf\" -o -name \"unattend.txt\" -o -name \"cesi.conf\" -o -name \"security.sav\" -o -name \"unattend.xml\" -o -name \"pwd.ibd\" -o -name \"docker-compose.yml\" -o -name \"RDCMan.settings\" -o -name \".rhosts\" -o -name \"*.cer\" -o -name \"datasources.xml\" -o -name \"secrets.yml\" -o -name \"pg_hba.conf\" -o -name \"smb.conf\" -o -name \"hudson.util.Secret\" -o -name \".secrets.mkey\" -o -name \"gvm-tools.conf\" -o -name \"rocketchat.service\" -o -name \"jetty-realm.properties\" -o -name \"SecEvent.Evt\" -o -name \"*vnc*.ini\" -o -name \"racoon.conf\" -o -name \"supervisord.conf\" -o -name \"*.sqlite3\" -o -name \"glusterfs.pem\" -o -name \"hosts.equiv\" -o -name \"debian.cnf\" -o -name \"*.db\" -o -name \"cloud.cfg\" -o -name \"glusterfs.key\" -o -name \"anaconda-ks.cfg\" -o -name \"Elastix.conf\" -o -name \"*.psk\" -o -name \"ws_ftp.ini\" -o -name \"*.vhdx\" -o -name \"*.pem\" -o -name \"FreeSSHDservice.ini\" -o -name \"recentservers.xml\" -o -name \"my.ini\" -o -name \".profile\" -o -name \"unattended.xml\" -o -name \"setupinfo\" -o -name \"*knockd*\" -o -name \"iis6.log\" -o -name \"kibana.y*ml\" -o -name \"sip.conf\" -o -name \"*.vhd\" -o -name \"dockershim.sock\" -o -name \"*.pub\" -o -name \"krb5cc_*\" -o -name \"filezilla.xml\" -o -name \"atlantis.db\" -o -name \".boto\" -o -name \"sysprep.inf\" -o -name \"*vnc*.c*nf*\" -o -name \"docker.sock\" -o -name \"*vnc*.xml\" -o -name \"credentials.db\" -o -name \"protecteduserkey.bin\" -o -name \"known_hosts\" -o -name \"db.php\" -o -name \"pgadmin4.db\" -o -name \"ntuser.dat\" -o -name \"snyk.json\" -o -name \"authorized_hosts\" -o -name \"KeePass.ini\" -o -name \"hostapd.conf\" -o -name \"*vnc*.txt\" -o -name \"amportal.conf\" -o -name \"grafana.ini\" -o -name \"backup\" -o -name \".erlang.cookie\" -o -name \"api_key\" -o -name \"unattend.inf\" -o -name \".plan\" -o -name \"kcpassword\" -o -name \"mysqld.cnf\" -o -name \"ipsec.conf\" -o -name \"*.keyring\" -o -name \"webserver_config.py\" -o -name \"vsftpd.conf\" -o -name \"index.dat\" -o -name \"*.csr\" -o -name \"bitcoin.conf\" -o -name \"sentry.conf.py\" -o -name \"authorized_keys\" -o -name \".pypirc\" -o -name \"*.gpg\" -o -name \".env*\" -o -name \"*.kdbx\" -o -name \"TokenCache.dat\" -o -name \"000-default.conf\" -o -name \"passbolt.php\" -o -name \"web*.config\" -o -name \"postgresql.conf\" -o -name \"legacy_credentials.db\" -o -name \"influxdb.conf\" -o -name \"frakti.sock\" -o -name \"storage.php\" -o -name \".github\" -o -name \"Ntds.dit\" -o -name \"*.sqlite\" -o -name \".git\" -o -name \".credentials.json\" -o -name \"pgadmin*.db\" -o -name \"glusterfs.ca\" -o -name \"krb5.conf\" -o -name \"*_history*\" -o -name \"*.pfx\" -o -name \"elasticsearch.y*ml\" -o -name \"accessTokens.json\" -o -name \"gitlab.yml\" -o -name \"config.xml\" -o -name \".wgetrc\" -o -name \".recently-used.xbel\" -o -name \"setupinfo.bak\" -o -name \"https-xampp.conf\" -o -name \"id_dsa*\" -o -name \"credentials.xml\" -o -name \".flyrc\" -o -name \"ddclient.conf\" -o -name \"autounattend.xml\" -o -name \"*.crt\" -o -name \".vault-token\" -o -name \"KeePass.config*\" -o -name \"database.php\" -o -name \"docker.socket\" -o -name \"AzureRMContext.json\" -o -name \"crio.sock\" -o -name \"default.sav\" -o -name \"NetSetup.log\" -o -name \"rpcd\" -o -name \"ipsec.secrets\" -o -name \"Dockerfile\" -o -name \"fat.config\" -o -name \"*password*\" -o -name \".sudo_as_admin_successful\" -o -name \"*config*.php\" -o -name \"*.service\" -o -name \"gitlab.rm\" -o -name \"drives.xml\" -o -name \"config.php\" -o -name \"passwd\" -o -name \"backups\" -o -name \"*.der\" -o -name \"access_tokens.json\" -o -name \"*credential*\" -o -name \"*.pgp\" -o -name 